...
import com.hedera.agentplatform.accounts.agent.AccountAgent;
...
public class AdminUserController {
    ...
    public AdminUserController(AdminUserService service, AccountAgent agent){this.service=service;this.agent=agent;}
    @PostMapping("/agent") public AgentResult agent(@RequestHeader(value="Authorization",required=false) String auth,@RequestBody AgentRequest request){return agent.execute(agent.planForAdmin(request, auth));}
