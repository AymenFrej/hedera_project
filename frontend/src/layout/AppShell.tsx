...
const titles: Record<string, string> = { '/workspace': 'Overview', '/accounts': 'My Wallet', '/assistant': 'AI Assistant', '/admin/users': 'Manage Users', '/audit': 'Audit & Monitoring', '/policies': 'Policies', '/approvals': 'Approvals', '/settings': 'Settings', '/payments': 'Payments · Mock', '/tokens': 'Tokens · Mock' }
...
export default function AppShell() {
  ...
  return <div className="app-shell"><Sidebar/><main className="main">
    ...
    <footer className="footer"><span>Development workspace</span><span>Payments, Tokens and AI agents are placeholders</span></footer>
  </main></div>
}
