...
const titles: Record<string, string> = { '/workspace': 'Overview', '/accounts': 'My Wallet', '/admin/users': 'Manage Users', '/audit': 'Audit & Monitoring', '/policies': 'Policies', '/approvals': 'Approvals', '/settings': 'Settings', '/payments': 'Payments', '/tokens': 'Tokens' }
